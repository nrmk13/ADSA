...
| Tokens | 3 / 5 | No token documentation found in the guides. 1 named token defined in asset catalog (Sources/AcmeKit/Resources/Colors.xcassets), e.g. AccentPrimary — real, but nothing in prose describes when to use which. No motion documentation; no spacing documentation. |
| Patterns | 1 / 5 | Components only. Nothing describes how a page is assembled. |
| Accessibility documentation | 3 / 5 | 1 of 2 guides carry a VoiceOver/Dynamic Type section (50%). No automated accessibility check found. |
